...
def main():
    ...
    print("\n[1/2] Initializing database schema...")
    init_database()
    print("  ✓ Database schema ready")

    # Step 2: Initialize region reference database
    print("\n[2/2] Initializing region reference database...")
    from region_database_init import initialize_region_database
